...
export default function Register() {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulated registration feedback
    setTimeout(() => {
      setIsLoading(false);
      setNotice({
        type: 'info',
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    ...
                    >
                      ...
                      <div className={`w-4 h-4 rounded-full border flex items-center justify-center shrink-0 ml-1.5 ${
                        ...
                        {role === 'supplier' && <div className="w-2 h-2 rounded-full bg-emerald-700" />}
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className={`w-4 h-4 rounded-full border flex items-center justify-center shrink-0 ml-1.5 ${
                        ...
                        {role === 'buyer' && <div className="w-2 h-2 rounded-full bg-emerald-700" />}
                      </div>
                    </button>
